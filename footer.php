	...
	<footer id="footer">
		...
		<?php if ( has_nav_menu('footer') ): ?>
			<div id="wrap-nav-footer" class="wrap-nav">
				<?php \Personalias\Nav::nav_menu(array('theme_location'=>'footer','menu_id' => 'nav-footer','fallback_cb'=> false)); ?>
			</div>
		<?php endif; ?>
			...
			<div class="pad group">
				...
				<div class="grid one-full">
					...
					<div id="copyright">
						...
						<?php else: ?>
							<p><?php bloginfo(); ?> &copy; <?php echo esc_html( date_i18n( esc_html__( 'Y', 'personalias' ) ) ); ?>. <?php esc_html_e( 'All Rights Reserved.', 'personalias' ); ?></p>
						<?php endif; ?>
					</div><!--/#copyright-->
					
					<?php if ( get_theme_mod( 'credit', 'on' ) == 'on' ): ?>
					<div id="credit">
						<p><?php esc_html_e('Powered by','personalias'); ?> <a href="http://wordpress.org" rel="nofollow">WordPress</a>. <?php esc_html_e('Theme by','personalias'); ?> <a href="https://agnarson.com" rel="nofollow">Alx</a>.</p>
					</div><!--/#credit-->
					<?php endif; ?>
